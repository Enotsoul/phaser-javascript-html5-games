...
BasicGame.Preloader.prototype = {
	...
	preload: function () {
		...
		this.load.image("heroSprite", "assets/square.png");
		//this.load.spritesheet('hero', 'assets/neatboy_running.png', 113, 176);
		this.load.spritesheet('hero', 'assets/neatboy_running_medium.png', 64, 100);
